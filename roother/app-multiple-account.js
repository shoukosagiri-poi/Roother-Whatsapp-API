...
const port = process.env.PORT || 8080 || 5000 || 3000 || 80;
...
app.post('/send-message', async (req, res) => {
  ...
  console.log(req.query.nomorhp);
  console.log(req.query.pesan);
  console.log("==========================================================");
  console.log(req.body.nomorhp);
  console.log(req.body.pesan);

  // const sender = req.query.sender;
  const sender = 'shoukosagiri';
  const number = phoneNumberFormatter(req.body.nomorhp || req.query.nomorhp || '081234567890');
  const message = req.body.pesan || req.query.pesan || 'Hello World!';
  ...
  if (!isRegisteredNumber) {
    return res.status(422).json({
      status: false,
      message: 'The number is not registered or your params not valid!'
    });
  }
